...
INSERT INTO OWNER (ssn, firstname, lastname, address, phone_number, email, password, property_type, isAdmin) VALUES ('121435904', 'Lambros', 'Gesoulis', 'Zakinthou 13', '6954123554', 'lg@test.gr', 'lg726925', MAISONETTE, true);
INSERT INTO OWNER (ssn, firstname, lastname, address, phone_number, email, password, property_type, isAdmin) VALUES ('398135972', 'George', 'Dougkas', 'Dramas 4', '6954123554', 'gd@test.gr', 'gd726925', MAISONETTE, false);
INSERT INTO OWNER (ssn, firstname, lastname, address, phone_number, email, password, property_type, isAdmin) VALUES ('461789591', 'Katerina', ' Kanellopoulou', 'Akratas 25', '6954123554', 'kk@test.gr', 'kk726925', MAISONETTE, false);
INSERT INTO OWNER (ssn, firstname, lastname, address, phone_number, email, password, property_type, isAdmin) VALUES ('731435934', 'Vasileios', 'Nikoulis', 'Evoias 11', '6954123554', 'vn@test.gr', 'vn726925', MAISONETTE, true);
